 ...
 return (
  <div className="flex">
   {tabs.map(({ icon: Icon, text }, index) => {
    const active =
     tab === index ? " border-b-primary font-bold dark:border-b-secondary" : "";
    ...
    return (
     ...
     >
      <div
       className={`block h-full pt-3 pb-2 text-sm text-center border-b-4 border-transparent border-solid text-inherit ${active}`}
      >
       {Icon && <Icon />}
       {text}
      </div>
