    ...
    <div className="flex flex-col max-w-2xl gap-2 py-4 mb-8 border-2 border-transparent border-solid divide-y dark:divide-lotion-translucent sm:mb-0 sm:border-smoky-black-translucent sm:dark:border-lotion-translucent border-t-transparent border-b-transparent">
     <section className="flex flex-col gap-2 px-2 py-8">
      ...
      <p className="text-sm opacity-90">
       ...
       personalize the content we show you. By continuing to use our website, you consent
     ...
     <section className="px-2 py-8 opacity-90">
      ...
      <p className="text-sm">
       ...
       website. They are widely used to make websites work, or work more efficiently, as
     ...
     <section className="px-2 py-8 opacity-90">
      ...
      <ol className="list-[square] px-4 text-sm">
       <li>
        <span className="underline">Session Cookies</span>: These are temporary cookies
        that expire when you close your browser. They are used to keep track of your
        preferences while you navigate through the website.
       </li>
       <li>
        <span className="underline">Persistent Cookies</span>: These cookies remain on
        your device until they expire or you delete them. They are used to remember your
     ...
     <section className="px-2 py-8 opacity-90">
      ...
      <p className="text-sm">
       You can manage cookies by adjusting your browser settings. Most browsers allow you
       to block or delete cookies, but doing so may affect your ability to use some
       features of our website. If you have any questions or concerns about our use of
